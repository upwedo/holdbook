...
<title>证券后台管理系统-系统管理员</title>
		...
		<div id="main-content">
			...
			<div class="clear"></div>
			<!-- End .clear -->
			<form action="processDaoImpl.do" method="post" >
			<s:if test="addDaoImplTip!=null">
			...
			<div style="display: block;" class="tab-content" id="tab2">
							<fieldset>
								...
								<p>
									...
									<input	class="text-input small-input" id="small-input"name="dp_entityName" type="text" value="${session.entityName}">								
								</p>
								<p>
									<label>Dao名称</label> 
									<input	class="text-input small-input" id="small-input"name="dp_daoName" type="text">								
								</p>
								<p>
									<label>DaoImpl名称</label> 
									<input	class="text-input small-input" id="small-input"name="dp_daoImplName" type="text"  <s:if test="#session.entityName!=null">value="${session.entityName}DaoImpl"</s:if>>								
								</p>
								<p>
									<label>@Repository</label> 
									<input	class="text-input small-input" id="small-input"name="dp_DaoImplRepository" type="text">								
								</p>
									<small>默认为DaoImpl名称首字母小写</small>
